...
<div class="row gutters">
   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
      <div class="card">
         <div class="card-header">Purchase entry List <a class="btn btn-outline-primary pull-right btn-sm" href='{{ url('/admin/purchaseentry/create/')}}'>Add new</a></div>
            ...
            <table id="basicExample" class="table table-striped table-bordered">
               ...
               <tbody>
                  ...
                  <tr class="text-center">
                     ...
                     <td>{{$value->inv_no}}</td>
                     <td>{{$value->amount}}</td>
                     <td>{{$value->billtype}}</td>
                     <td>{{$value->billdiscount}}</td>
